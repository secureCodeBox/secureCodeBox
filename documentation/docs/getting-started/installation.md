...
The secureCodeBox supports the 4 latest Kubernetes releases (`v1.37`, `v1.36`, `v1.35` & `v1.34`). Older versions might also work but are not officially supported or tested.
