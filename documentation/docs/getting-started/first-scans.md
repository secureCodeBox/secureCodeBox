...
To view the actual findings produced by the scan you can use the download link to download the findings as JSON from Garage/S3.

:::note
When using the default Garage installation, you'll need to port-forward the to be able to access the finding download link. See: [installation](/docs/getting-started/installation#accessing-the-included-garage-instance)
:::
