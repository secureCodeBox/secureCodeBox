...
public class V1ScanSpecCascadesMatchExpressions {
  ...
  public V1ScanSpecCascadesMatchExpressions key(String key) {
  ...
  **/
  ...
  public V1ScanSpecCascadesMatchExpressions operator(String operator) {
  ...
  **/
  ...
  public V1ScanSpecCascadesMatchExpressions values(List<String> values) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ScanSpecCascadesMatchExpressions v1ScanSpecCascadesMatchExpressions = (V1ScanSpecCascadesMatchExpressions) o;
    return Objects.equals(this.key, v1ScanSpecCascadesMatchExpressions.key) &&
        Objects.equals(this.operator, v1ScanSpecCascadesMatchExpressions.operator) &&
        Objects.equals(this.values, v1ScanSpecCascadesMatchExpressions.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ScanSpecCascadesMatchExpressions {\n");
