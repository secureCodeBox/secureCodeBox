...
public class V1ScanSpecFc {
  ...
  public V1ScanSpecFc fsType(String fsType) {
  ...
  **/
  ...
  public V1ScanSpecFc lun(Integer lun) {
  ...
  **/
  ...
  public V1ScanSpecFc readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1ScanSpecFc targetWWNs(List<String> targetWWNs) {
    
    this.targetWWNs = targetWWNs;
    return this;
  }

  public V1ScanSpecFc addTargetWWNsItem(String targetWWNsItem) {
  ...
  **/
  ...
  public V1ScanSpecFc wwids(List<String> wwids) {
    
    this.wwids = wwids;
    return this;
  }

  public V1ScanSpecFc addWwidsItem(String wwidsItem) {
    if (this.wwids == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ScanSpecFc v1ScanSpecFc = (V1ScanSpecFc) o;
    return Objects.equals(this.fsType, v1ScanSpecFc.fsType) &&
        Objects.equals(this.lun, v1ScanSpecFc.lun) &&
        Objects.equals(this.readOnly, v1ScanSpecFc.readOnly) &&
        Objects.equals(this.targetWWNs, v1ScanSpecFc.targetWWNs) &&
        Objects.equals(this.wwids, v1ScanSpecFc.wwids);
  }
