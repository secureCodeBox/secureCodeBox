...
public class V1ScanSpecIscsiSecretRef {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;


  public V1ScanSpecIscsiSecretRef name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ScanSpecIscsiSecretRef v1ScanSpecIscsiSecretRef = (V1ScanSpecIscsiSecretRef) o;
    return Objects.equals(this.name, v1ScanSpecIscsiSecretRef.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ScanSpecIscsiSecretRef {\n");
