...
public class V1ScanSpecConfigMap {
  ...
  public V1ScanSpecConfigMap defaultMode(Integer defaultMode) {
  ...
  **/
  ...
  public V1ScanSpecConfigMap items(List<V1ScanSpecConfigMapItems> items) {
    
    this.items = items;
    return this;
  }

  public V1ScanSpecConfigMap addItemsItem(V1ScanSpecConfigMapItems itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public V1ScanSpecConfigMap name(String name) {
  ...
  **/
  ...
  public V1ScanSpecConfigMap optional(Boolean optional) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ScanSpecConfigMap v1ScanSpecConfigMap = (V1ScanSpecConfigMap) o;
    return Objects.equals(this.defaultMode, v1ScanSpecConfigMap.defaultMode) &&
        Objects.equals(this.items, v1ScanSpecConfigMap.items) &&
        Objects.equals(this.name, v1ScanSpecConfigMap.name) &&
        Objects.equals(this.optional, v1ScanSpecConfigMap.optional);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ScanSpecConfigMap {\n");
