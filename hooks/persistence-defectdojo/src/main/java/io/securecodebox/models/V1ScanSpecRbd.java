...
import io.securecodebox.models.V1ScanSpecRbdSecretRef;
...
public class V1ScanSpecRbd {
  ...
  private V1ScanSpecRbdSecretRef secretRef;
  ...
  public V1ScanSpecRbd fsType(String fsType) {
  ...
  **/
  ...
  public V1ScanSpecRbd image(String image) {
  ...
  **/
  ...
  public V1ScanSpecRbd keyring(String keyring) {
  ...
  **/
  ...
  public V1ScanSpecRbd monitors(List<String> monitors) {
    
    this.monitors = monitors;
    return this;
  }

  public V1ScanSpecRbd addMonitorsItem(String monitorsItem) {
  ...
  **/
  ...
  public V1ScanSpecRbd pool(String pool) {
  ...
  **/
  ...
  public V1ScanSpecRbd readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1ScanSpecRbd secretRef(V1ScanSpecRbdSecretRef secretRef) {
  ...
  **/
  ...
  public V1ScanSpecRbdSecretRef getSecretRef() {
    return secretRef;
  }


  public void setSecretRef(V1ScanSpecRbdSecretRef secretRef) {
    this.secretRef = secretRef;
  }


  public V1ScanSpecRbd user(String user) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ScanSpecRbd v1ScanSpecRbd = (V1ScanSpecRbd) o;
    return Objects.equals(this.fsType, v1ScanSpecRbd.fsType) &&
        Objects.equals(this.image, v1ScanSpecRbd.image) &&
        Objects.equals(this.keyring, v1ScanSpecRbd.keyring) &&
        Objects.equals(this.monitors, v1ScanSpecRbd.monitors) &&
        Objects.equals(this.pool, v1ScanSpecRbd.pool) &&
        Objects.equals(this.readOnly, v1ScanSpecRbd.readOnly) &&
        Objects.equals(this.secretRef, v1ScanSpecRbd.secretRef) &&
        Objects.equals(this.user, v1ScanSpecRbd.user);
  }
