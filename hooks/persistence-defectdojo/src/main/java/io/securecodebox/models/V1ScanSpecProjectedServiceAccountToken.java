...
public class V1ScanSpecProjectedServiceAccountToken {
  ...
  public V1ScanSpecProjectedServiceAccountToken audience(String audience) {
  ...
  **/
  ...
  public V1ScanSpecProjectedServiceAccountToken expirationSeconds(Long expirationSeconds) {
  ...
  **/
  ...
  public V1ScanSpecProjectedServiceAccountToken path(String path) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1ScanSpecProjectedServiceAccountToken v1ScanSpecProjectedServiceAccountToken = (V1ScanSpecProjectedServiceAccountToken) o;
    return Objects.equals(this.audience, v1ScanSpecProjectedServiceAccountToken.audience) &&
        Objects.equals(this.expirationSeconds, v1ScanSpecProjectedServiceAccountToken.expirationSeconds) &&
        Objects.equals(this.path, v1ScanSpecProjectedServiceAccountToken.path);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ScanSpecProjectedServiceAccountToken {\n");
