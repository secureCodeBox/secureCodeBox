...
If you you use the persistence-elastic or use some kind of dashboard, you can set the variable `VULNMANAG_ENABLED` to true, `VULNMANAG_DASHBOARD_URL` to the URL of your dashboard.
