...
A Helm chart for the Typo3 security scanner that integrates with the secureCodeBox

**Homepage:** <https://docs.securecodebox.io/docs/scanners/typo3scan>
...
| scanner.image.repository | string | `"docker.io/securecodebox/typo3scan"` | Container Image to run the scan |
