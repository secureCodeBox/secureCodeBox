...
## What is vulnerable-log4j?

Insecure & Outdated Java Instance using log4j: Never expose it to the internet!

### Source Code

* <https://github.com/secureCodeBox/secureCodeBox/tree/master/demo-targets/vulnerable-log4j>

## Deployment
The vulnerable-log4j chart can be deployed via helm:
