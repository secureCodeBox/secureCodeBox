...
func (in *CascadeSpec) DeepCopyInto(out *CascadeSpec) {
	*out = *in
	in.ScanAnnotationSelector.DeepCopyInto(&out.ScanAnnotationSelector)
...
func (in *ParseDefinitionSpec) DeepCopyInto(out *ParseDefinitionSpec) {
	*out = *in
	if in.SelectorAttributeMappings != nil {
		in, out := &in.SelectorAttributeMappings, &out.SelectorAttributeMappings
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScanAnnotationSelector) DeepCopyInto(out *ScanAnnotationSelector) {
	*out = *in
	if in.AnyOf != nil {
		in, out := &in.AnyOf, &out.AnyOf
		*out = make([]ScanAnnotationSelectorRequirement, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScanAnnotationSelector.
func (in *ScanAnnotationSelector) DeepCopy() *ScanAnnotationSelector {
	if in == nil {
		return nil
	}
	out := new(ScanAnnotationSelector)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScanAnnotationSelectorRequirement) DeepCopyInto(out *ScanAnnotationSelectorRequirement) {
	*out = *in
	if in.Values != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScanAnnotationSelectorRequirement.
func (in *ScanAnnotationSelectorRequirement) DeepCopy() *ScanAnnotationSelectorRequirement {
	if in == nil {
		return nil
	}
	out := new(ScanAnnotationSelectorRequirement)
	in.DeepCopyInto(out)
	return out
}
