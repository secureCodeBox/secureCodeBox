...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterScanTypeStatus) DeepCopyInto(out *ClusterScanTypeStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterScanTypeStatus.
func (in *ClusterScanTypeStatus) DeepCopy() *ClusterScanTypeStatus {
	if in == nil {
		return nil
	}
	out := new(ClusterScanTypeStatus)
	in.DeepCopyInto(out)
	return out
}
