...
require (
	...
	github.com/secureCodeBox/secureCodeBox/auto-discovery/kubernetes v0.0.0-20231009114358-c5a65b0a38da
	github.com/secureCodeBox/secureCodeBox/operator v0.0.0-20230926134536-ff777849ca12
	k8s.io/api v0.28.2
