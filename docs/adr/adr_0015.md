...
# ADR-0015: Enable container autodiscovery to scan container images from private registries
...
| <!-- -->       | <!-- --> |
|----------------|----------|
| **Status**:    | DRAFT [ADR-0015](ADR-0015.md) |
| **Date**:      | 2022-09-13 |
